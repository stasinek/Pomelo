...
! function(t) {
    ...
    console.log("album loaded"), $(".content").sortable({
        stop: function(t, e) {
            var i = e.item.data("album-id"),
                n = $(".content").children().map(function() {
                    return $(this).data("id")
                }).get();
    ...
    if (t instanceof Array == !1 && (t = [t]), e.fn = function() {
        ...
        }, "0" === t.toString()) e.title = "Clear Unsorted", i.title = "Keep Unsorted", n = "<p>Are you sure you want to delete all photos from 'Unsorted'?<br>This action can't be undone!</p>";
    else if (1 === t.length) {
        var s = "";
    ...
    var e = "",
        i = api.path + "?function=Album::getArchive&albumID=" + t;
    ...
    path: "php/index.php",
    onError: null
}, api.post = function(t, e, i) {
    loadingBar.show(), e = $.extend({
        function: t
    }, e);
    var n = function(t) {
    ...
    switch (e += "\n\t        <div class='no_content fadeIn'>\n\t            " + build.iconic(t) + "\n\t        ", t) {
        case "magnifying-glass":
            ...
            break;
        case "eye":
            e += "<p>No public albums</p>";
            break;
        case "cog":
            e += "<p>No configuration</p>";
            break;
        case "question-mark":
            e += "<p>Photo not found</p>"
    }
    return e += "</div>"
    ...
    })) : e = "<div class='empty'>No Tags</div>", e
    ...
    var i = albums.json && albums.json.albums && Object.keys(albums.json.albums).length > 1,
        n = [{
    ...
    var i = t.length > 1,
        n = albums.json && albums.json.albums && Object.keys(albums.json.albums).length > 1,
        s = [{
    ...
    var i = photo.getViewLink(t),
        n = [{
            title: '<input readonly id="link" value="' + i + '">',
            fn: function() {},
    ...
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Untitled",
        e = header.dom(".header__title"),
        i = lychee.html(_templateObject25, t, build.iconic("caret-bottom"));
    return e.html(i), !0
    ...
    api.post("Session::init", {}, function(t) {
        if (2 === t.status) lychee.sortingPhotos = t.config.sortingPhotos || "", lychee.sortingAlbums = t.config.sortingAlbums || "", lychee.dropboxKey = t.config.dropboxKey || "", lychee.location = t.config.location || "", lychee.checkForUpdates = t.config.checkForUpdates || "1", !1 === t.config.login && settings.createLogin();
        else if (1 === t.status) lychee.checkForUpdates = t.config.checkForUpdates || "1", lychee.setMode("public");
        else if (0 === t.status) return lychee.setMode("public"), header.dom().hide(), lychee.content.hide(), $("body").append(build.no_content("cog")), settings.createConfig(), !0;
    ...
    var t = "",
        e = "",
        i = document.location.hash.replace("#", "").split("/");
    ...
    for (var n = 0; n < i.length; n++)
        for (var s = 0; s < i[n].length; s++)
            if (i[n][s] == e) return t.removeClass(i[n][0] + " " + i[n][1]).addClass(e), !0;
    return !1
}, lychee.retinize = function() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
        e = t.split(".").pop(),
        i = "svg" !== e;
    return !0 === i && (t = t.replace(/\.[^\/.]+$/, ""), t = t + "@2x." + e), {
        path: t,
        isPhoto: i
    }
    ...
    var t = {
        ...
        e = {
            width: t.width - multiselect.position.right + 2,
            height: t.height - multiselect.position.bottom
        },
        i = {
            pageX: t.width - multiselect.position.right / 2,
            pageY: t.height - multiselect.position.bottom
        };
    ...
    value: ""
}, password.get = function(t, e) {
    !1 === lychee.publicMode ? e() : album.json && "0" === album.json.password ? e() : albums.json && "0" === albums.getByID(t).password ? e() : albums.json || album.json ? password.getDialog(t, e) : (album.json = {
        password: !0
    }, e(""))
    ...
    if (album.json && album.json.content && album.json.content[t] && "" != album.json.content[t].nextPhoto) {
        var e = album.json.content[t].nextPhoto,
            i = album.json.content[e].url,
            n = album.json.content[e].medium,
            s = null != n && "" !== n ? n : i;
    ...
    }, 1 === t.length ? (e.title = "Delete Photo", i.title = "Keep Photo", n = lychee.html(_templateObject27, s)) : (e.title = "Delete Photo", i.title = "Keep Photo", n = lychee.html(_templateObject28, t.length)), basicModal.show({
        body: n,
        buttons: {
            action: {
                title: e.title,
    ...
    visible.photo() && (photo.json.public = "0" === photo.json.public ? "1" : "0", view.photo.public(), "1" === photo.json.public && contextMenu.sharePhoto(t, e)), album.json.content[t].public = "0" === album.json.content[t].public ? "1" : "0", view.album.content.public(t), albums.refresh(), api.post("Photo::setPublic", {
        photoID: t
    }, function(t) {
        !0 !== t && lychee.error(null, params, t)
    })
}, photo.setDescription = function(t) {
    var e = photo.json.description,
        i = function(e) {
            basicModal.close();
            var i = e.description;
    ...
    var e = "",
        i = "";
    if (!t) return !1;
    if (t instanceof Array == !1 && (t = [t]), visible.photo()) e = photo.json.tags;
    else if (visible.album() && 1 === t.length) e = album.json.content[t].tags;
    else if (visible.search() && 1 === t.length) e = album.json.content[t].tags;
    else if (visible.album() && t.length > 1) {
        var n = !0;
    ...
    var e = void 0,
        i = api.path + "?function=Photo::getArchive&photoID=" + t;
    e = location.href.indexOf("index.html") > 0 ? location.href.replace(location.hash, "").replace("index.html", i) : location.href.replace(location.hash, "") + i, !0 === lychee.publicMode && (e += "&password=" + encodeURIComponent(password.value)), location.href = e
    ...
    clearTimeout($(window).data("timeout")), $(window).data("timeout", setTimeout(function() {
        0 !== header.dom(".header__search").val().length ? api.post("search", {
            ...
            var e = "",
                i = "",
                n = "";
            t && t.albums && (albums.json = {
                albums: t.albums
            }, $.each(albums.json.albums, function() {
                albums.parse(this), i += build.album(this)
            })), t && t.photos && (album.json = {
                content: t.photos
    ...
    var e = !1,
        i = t.takestamp + t.make + t.model + t.shutter + t.aperture + t.focal + t.iso,
        n = {},
        s = "";
    ...
    url: function() {
        ...
        var i = function(t) {
            var i = [];
            t.link && t.link.length > 3 ? (basicModal.close(), i[0] = {
                name: t.link
            }, upload.show("Importing URL", i, function() {
    ...
    server: function() {
        ...
        var e = function(e) {
            ...
            i[0] = {
                name: e.path
            }, upload.show("Importing from server", i, function() {
                $(".basicModal .rows .row .status").html("Importing");
                var i = {
                    albumID: t,
                    path: e.path
    ...
    dropbox: function() {
        ...
        !1 === t && (t = 0);
        var e = function(e) {
            for (var i = "", n = 0; n < e.length; n++) i += e[n].link + ",", e[n] = {
                name: e[n].link
            };
    ...
    content: {
        ...
        delete: function(t) {
            $('.album[data-id="' + t + '"]').css("opacity", 0).animate({
                width: 0,
                marginLeft: 0
            }, 300, function() {
    ...
    content: {
        ...
        delete: function(t) {
            $('.photo[data-id="' + t + '"]').css("opacity", 0).animate({
                width: 0,
                marginLeft: 0
            }, 300, function() {
    ...
    sidebar: function(t) {
        ...
        if ((visible.album() || !album.json.init) && !visible.photo()) {
            var t = sidebar.createStructure.album(album.json),
                e = sidebar.render(t);
    ...
    photo: function(t) {
        ...
        var t = lychee.imageview.find("a#next"),
            e = lychee.imageview.find("a#previous"),
            i = photo.getID(),
        ...
        if (!1 === n || !0 === lychee.viewMode) t.hide();
        else {
            var o = album.json.content[i].nextPhoto,
                a = album.json.content[o];
            t.css("background-image", lychee.html(_templateObject41, a.thumbUrl))
        }
        if (!1 === s || !0 === lychee.viewMode) e.hide();
        else {
            var r = album.json.content[i].previousPhoto,
                l = album.json.content[r];
    ...
    sidebar: function(t) {
        ...
        var t = sidebar.createStructure.photo(photo.json),
            e = sidebar.render(t);
        sidebar.dom(".sidebar__wrapper").html(e), sidebar.bind()
    })
