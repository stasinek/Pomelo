...
function gup(e) {
    ...
    function v(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++) r = e[o], r.style && (n = r.style.display, t ? ("none" === n && (i[o] = qe.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && We(r) && (i[o] = g(r))) : "none" !== n && (i[o] = "none", qe.set(r, "display", n)));
    ...
    function x(e, t, n, r, i) {
        for (var o, a, s, l, u, c, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            ...
            for (a = a || d.appendChild(t.createElement("div")), s = (Xe.exec(o) || ["", ""])[1].toLowerCase(), l = Ve[s] || Ve._default, a.innerHTML = l[1] + me.htmlPrefilter(o) + l[2], c = l[0]; c--;) a = a.lastChild;
    ...
    function D(e, t) {
        ...
        if (1 === t.nodeType) {
            if (qe.hasData(e) && (o = qe.access(e), a = qe.set(t, o), u = o.events)) {
                ...
                for (i in u)
                    for (n = 0, r = u[i].length; n < r; n++) me.event.add(t, i, u[i][n])
            }
    ...
    function $(e, t, r, i) {
        ...
        var o, a, s, l, u, c, d = 0,
            ...
            h = t[0],
            m = me.isFunction(h);
        if (m || f > 1 && "string" == typeof h && !pe.checkClone && nt.test(h)) return e.each(function(n) {
            var o = e.eq(n);
            m && (t[0] = h.call(this, n, o.html())), $(o, t, r, i)
        });
        if (f && (o = x(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            for (s = me.map(b(o, "script"), j), l = s.length; d < f; d++) u = o, d !== p && (u = me.clone(u, !0, !0), l && me.merge(s, b(u, "script"))), r.call(e[d], u, d);
            if (l)
                for (c = s[s.length - 1].ownerDocument, me.map(s, E), d = 0; d < l; d++) u = s[d], Ye.test(u.type || "") && !qe.access(u, "globalEval") && me.contains(c, u) && (u.src ? me._evalUrl && me._evalUrl(u.src) : n(u.textContent.replace(it, ""), c))
        }
        return e
    }

    function A(e, t, n) {
        for (var r, i = t ? me.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || me.cleanData(b(r)), r.parentNode && (n && me.contains(r.ownerDocument, r) && y(b(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    ...
    function H(e, t, n, r, i) {
        var o, a = 0;
        for (o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2) "margin" === n && (a += me.css(e, n + Re[o], !0, i)), r ? ("content" === n && (a -= me.css(e, "padding" + Re[o], !0, i)), "margin" !== n && (a -= me.css(e, "border" + Re[o] + "Width", !0, i))) : (a += me.css(e, "padding" + Re[o], !0, i), "padding" !== n && (a += me.css(e, "border" + Re[o] + "Width", !0, i)));
        return a
    }
    ...
    function U(e, t, n) {
        ...
        if ((l = !me.isEmptyObject(t)) || !me.isEmptyObject(p)) {
            ...
            })), l = B(m ? g[r] : 0, r, f), r in g || (g[r] = l.start, m && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function X(e, t, n) {
        var r, i, o = 0,
            ...
            l = function() {
                if (i) return !1;
                for (var t = ht || R(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; a < l; a++) u.tweens[a].run(o);
    ...
    var xe = function(e) {
        function t(e, t, n, r) {
            var i, o, a, s, l, c, f, p = t && t.ownerDocument,
                h = t ? t.nodeType : 9;
            ...
            if (!r && ((t ? t.ownerDocument || t : F) !== A && $(t), t = t || A, L)) {
                ...
                if (x.qsa && !U[e + " "] && (!O || !O.test(e))) {
                    if (1 !== h) p = t, f = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(ye, xe) : t.setAttribute("id", s = M), c = _(e), o = c.length; o--;) c[o] = "#" + s + " " + d(c[o]);
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || a)
                            if (d = t[M] || (t[M] = {}), c = d[t.uniqueID] || (d[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                                ...
                                if ((u = c[o]) && u[0] === I && u[1] === s) return f[2] = u[2];
        ...
        function g(e, t, n, i, o, a) {
            return i && !i[M] && (i = g(i)), o && !o[M] && (o = g(o, a)), r(function(r, a, s, l) {
                var u, c, d, f = [],
                    ...
                    y = n ? o || (r ? e : g || i) ? [] : a : b;
                if (n && n(b, y, s, l), i)
                    for (u = m(y, p), i(u, [], s, l), c = u.length; c--;)(d = u[c]) && (y[p[c]] = !(b[p[c]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (c = y.length; c--;)(d = y[c]) && (u = o ? K(r, d) : f[c]) > -1 && (r[u] = !(a[u] = d))
                    }
                } else y = m(y === a ? y.splice(g, y.length) : y), o ? o(null, a, y, l) : Q.apply(a, y)
            })
        }
        ...
        var y, x, w, T, C, _, k, j, E, D, S, $, A, N, L, O, q, P, H, M = "sizzle" + 1 * new Date,
            F = e.document,
            I = 0,
            R = 0,
            W = n(),
        ...
        x = t.support = {}, C = t.isXML = function(e) {
            ...
            return r !== A && 9 === r.nodeType && r.documentElement ? (A = r, N = A.documentElement, L = !C(A), F !== A && (n = A.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), x.attributes = i(function(e) {
                ...
                x.disconnectedMatch = P.call(e, "*"), P.call(e, "[s!='']:x"), q.push("!=", re)
            ...
            if ((e.ownerDocument || e) !== A && $(e), n = n.replace(le, "='$1']"), x.matchesSelector && L && !U[n + " "] && (!q || !q.test(n)) && (!O || !O.test(n))) try {
                var r = P.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && b) {
                                ...
                                for (;
                                    (f = ++p && f && f[m] || (y = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++y || (b && (d = f[M] || (f[M] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [I, y]), f !== t)););
        ...
        return c.prototype = w.filters = w.pseudos, w.setFilters = new c, _ = t.tokenize = function(e, n) {
            ...
            var n, r = [],
                ...
                o = U[e + " "];
            if (!o) {
                for (t || (t = _(e)), n = t.length; n--;) o = v(t[n]), o[M] ? r.push(o) : i.push(o);
                                ...
                                var s = this,
                                    ...
                                    d = function() {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            d = e && ("object" == typeof e || "function" == typeof e) && e.then, me.isFunction(d) ? i ? d.call(e, o(a, n, l, i), o(a, n, u, i)) : (a++, d.call(e, o(a, n, l, i), o(a, n, u, i), o(a, n, l, n.notifyWith))) : (r !== l && (s = void 0, c = [e]), (i || n.resolveWith)(s, c))
                                        }
                                    },
                                    f = i ? d : function() {
                                        try {
                                            ...
                                            me.Deferred.exceptionHook && me.Deferred.exceptionHook(e, f.stackTrace), t + 1 >= a && (r !== u && (s = void 0, c = [e]), n.rejectWith(s, c))
                                        }
                                    };
    ...
    f.uid = 1, f.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    Array.isArray(t) ? t = t.map(me.camelCase) : (t = me.camelCase(t), t = t in r ? [t] : t.match($e) || []), n = t.length;
                    for (; n--;) delete r[t[n]]
    ...
    me.extend({
        ...
        queue: function(e, t, n) {
            var r;
            if (e) return t = (t || "fx") + "queue", r = qe.get(e, t), n && (!r || Array.isArray(n) ? r = qe.access(e, t, me.makeArray(n)) : r.push(n)), r || []
        },
    ...
    me.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, l, u, c, d, f, p, h, m, g = qe.get(e);
            if (g)
                for (n.handler && (o = n, n = o.handler, i = o.selector), i && me.find.matchesSelector(Qe, i), n.guid || (n.guid = me.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
                    ...
                    }), t = (t || "").match($e) || [""], u = t.length; u--;) s = Ze.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p && (d = me.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, d = me.event.special[p] || {}, c = me.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
        ...
        remove: function(e, t, n, r, i) {
            var o, a, s, l, u, c, d, f, p, h, m, g = qe.hasData(e) && qe.get(e);
            if (g && (l = g.events)) {
                for (t = (t || "").match($e) || [""], u = t.length; u--;)
                    if (s = Ze.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (d = me.event.special[p] || {}, p = (r ? d.delegateType : d.bindType) || p, f = l[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = f.length; o--;) c = f[o], !i && m !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (f.splice(o, 1), c.selector && f.delegateCount--, d.remove && d.remove.call(e, c));
            ...
            if (s.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, s)) {
                for (a = me.event.handlers.call(this, s, u), t = 0;
                    ...
                    for (s.currentTarget = i.elem, n = 0;
                        (o = i.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, void 0 !== (r = ((me.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, l)) && !1 === (s.result = r) && (s.preventDefault(), s.stopPropagation()));
            ...
            if (l && u.nodeType && !("click" === e.type && e.button >= 1))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        for (o = [], a = {}, n = 0; n < l; n++) r = t[n], i = r.selector + " ", void 0 === a[i] && (a[i] = r.needsContext ? me(i, this).index(u) > -1 : me.find(i, this, null, [u]).length), a[i] && o.push(r);
                        o.length && s.push({
                            elem: u,
                            handlers: o
                        })
    ...
    me.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || me.isXMLDoc(e)))
                for (a = b(s), o = b(e), r = 0, i = o.length; r < i; r++) S(o[r], a[r]);
            if (t)
                if (n)
                    for (o = o || b(e), a = a || b(s), r = 0, i = o.length; r < i; r++) D(o[r], a[r]);
                else D(e, s);
        ...
        html: function(e) {
            return Le(this, function(e) {
                ...
                if ("string" == typeof e && !tt.test(e) && !Ve[(Xe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++) t = this[n] || {}, 1 === t.nodeType && (me.cleanData(b(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
    ...
    me.extend({
        ...
        me.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return !lt.test(me.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, r) : Be(e, ct, function() {
                    return M(e, t, r)
                })
            },
            set: function(e, n, r) {
        ...
        css: function(e, t) {
            return Le(this, function(e, t, n) {
                var r, i, o = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (r = st(e), i = t.length; a < i; a++) o[t[a]] = me.css(e, t[a], !1, r);
                    return o
                }
    ...
    me.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? me.prop(e, t, n) : (1 === o && me.isXMLDoc(e) || (i = me.attrHooks[t.toLowerCase()] || (me.expr.match.bool.test(t) ? bt : void 0)), void 0 !== n ? null === n ? void me.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : (r = me.find.attr(e, t), null == r ? void 0 : r))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    me.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : me.isFunction(e) ? this.each(function(n) {
                ...
                var t, r, i, o;
                if ("string" === n)
                    for (r = 0, i = me(this), o = e.match($e) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = V(this), t && qe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : qe.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, r = 0;
    ...
    me.extend(me.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = s = r = r || ne, 3 !== r.nodeType && 8 !== r.nodeType && !Ct.test(p + me.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, t = t[me.expando] ? t : new me.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : me.makeArray(n, [t]), d = me.event.special[p] || {}, i || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                ...
                for (o = 0;
                    (a = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : d.bindType || p, c = (qe.get(a, "events") || {})[t.type] && qe.get(a, "handle"), c && c.apply(a, n), (c = u && a[u]) && c.apply && Oe(a) && (t.result = c.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    Rt.href = _t.href, me.extend({
        ...
        ajax: function(t, n) {
            ...
            var i, o, a, s, l, u, c, d, f, p, h = me.ajaxSetup({}, n),
                m = h.context || h,
            ...
            d = me.event && h.global, d && 0 == me.active++ && me.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Pt.test(h.type), o = h.url.replace(Nt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(At, "+")) : (p = h.url.slice(o.length), h.data && (o += (jt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(Lt, "$1"), p = (jt.test(o) ? "&" : "?") + "_=" + kt++ + p), h.url = o + p), h.ifModified && (me.lastModified[o] && C.setRequestHeader("If-Modified-Since", me.lastModified[o]), me.etag[o] && C.setRequestHeader("If-None-Match", me.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && C.setRequestHeader("Content-Type", h.contentType), C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + It + "; q=0.01" : "") : h.accepts["*"]);
    ...
    pe.cors = !!Bt && "withCredentials" in Bt, pe.ajax = Bt = !!Bt, me.ajaxTransport(function(t) {
        var n, r;
    ...
    me.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = me.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + i) : !1 !== t.jsonp && (t.url += (jt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
        ...
        setOffset: function(e, t, n) {
            var r, i, o, a, s, l, u, c = me.css(e, "position"),
                d = me(e),
                f = {};
            "static" === c && (e.style.position = "relative"), s = d.offset(), o = me.css(e, "top"), l = me.css(e, "left"), u = ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1, u ? (r = d.position(), a = r.top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(l) || 0), me.isFunction(t) && (t = t.call(e, n, me.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : d.css(f)
        }
    }, me.fn.extend({
        offset: function(e) {
        ...
        me.cssHooks[t] = L(pe.pixelPosition, function(e, n) {
            if (n) return n = N(e, t), at.test(n) ? me(e).position()[t] + "px" : n
        })
    }), me.each({
        Height: "height",
        Width: "width"
...
function(e, t) {
    ...
    var e = null,
        ...
        c = function(t, n, i, o) {
            var s = a(t);
            document.body.insertAdjacentHTML("beforeend", s), null == e && (e = document.body.style.overflow, document.body.style.overflow = "hidden");
            var c = r(),
                d = l(n, c);
...
build = {}, build.iconic = function(e) {
    ...
    for (var r = 0; r < t.length;) {
        var i = t[r];
        i.name.length > 40 && (i.name = i.name.substr(0, 17) + "..." + i.name.substr(i.name.length - 20, 20)), n += lychee.html(_templateObject14, i.name), r++
    }
    return n += "</div>"
    ...
    var t = "",
        n = function(e) {
            ...
            return t += "\n\t\t         <div class='sidebar__divider'>\n\t\t             <h1>" + e.title + "</h1>\n\t\t         </div>\n\t\t         <table>\n\t\t         ", e.rows.forEach(function(e) {
                var n = e.value;
                "" !== n && null != n || (n = "-"), n = lychee.html(_templateObject17, e.title.toLowerCase(), n), !0 === e.editable && (n += " " + build.editIcon("edit_" + e.title.toLowerCase())), t += lychee.html(_templateObject18, e.title, n)
            }), t += "\n\t\t         </table>\n\t\t         "
        },
        r = function(e) {
            var t = "",
...
var lychee = {};
lychee.content = $(".content"), lychee.escapeHTML = function() {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
    return e += "", e = e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;").replace(/`/g, "&#96;")
}, lychee.html = function(e) {
    for (var t = e.raw, n = "", r = arguments.length, i = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) i[o - 1] = arguments[o];
...
$(document).ready(function() {
    var e = gup("p");
    api.onError = error, header.dom("#button_share").on("click", function(t) {
        contextMenu.sharePhoto(e, t)
    }), header.dom("#button_info").on("click", sidebar.toggle), loadPhotoInfo(e)
});
var loadPhotoInfo = function(e) {
        ...
        api.post("Photo::get", t, function(e) {
            if ("Warning: Photo private!" === e || "Warning: Wrong password!" === e) return $("body").append(build.no_content("question-mark")), $("body").removeClass("view"), header.dom().remove(), !1;
            e.title || (e.title = "Untitled"), document.title = "Lychee - " + e.title, header.dom(".header__title").html(lychee.escapeHTML(e.title)), imageview.html(build.imageview(e, !0)), imageview.find(".arrow_wrapper").remove(), imageview.addClass("fadeIn").show();
            var t = sidebar.createStructure.photo(e),
                n = sidebar.render(t);
            sidebar.dom(".sidebar__wrapper").html(n), sidebar.bind()
        })
    },
